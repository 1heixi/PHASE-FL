...
def dispatch_train(
    ...
    # 旧字段，保留兼容
    sparsity = cfg.get("task", {}).get("sparsity", None)
    ...
    # 优先使用 target_sparsity；没有则退回 task.sparsity
    ...
    if train_structure is not None and train_structure.upper() == "CIFAR_RN18_FIX_PRUNE":
        return (
